...
ridInput.position(displayWidth/2-600,displayHeight/2+70);
ridInput.hide();
...
ridIndex = 1;
ridInput.show();
ridQ.html("I am a home for royalty.There are many of me in England.I am made of stone.I am protected by a ring of water.I'm found in many legends.")
ridQ.show();
rid_greeting.show();
ridSubmit.show();
}
...
ridIndex = 2;
ridInput.show();
ridQ.html("It cannot be seen, it weighs nothing, but when you put it in a barrel it makes it lighter. What is it?")
ridQ.show();
rid_greeting.show();
ridSubmit.show();
}
